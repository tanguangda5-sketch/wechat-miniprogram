...
1. 小程序前端负责页面展示、交互处理、用户操作引导及业务入口组织。
2. 云函数服务层负责登录鉴权、数据查询、订单处理、消息交互和业务逻辑执行。
3. 云端数据支撑层负责用户数据、活动数据、景点数据、酒店数据、商品数据、订单数据及知识内容数据的存储和管理。
...
1. 采用微信小程序形态，用户无需额外安装独立 App 即可使用，降低使用门槛。
2. 通过微信云开发与云函数实现前后端协同，简化部署与维护流程。
3. 将活动、景点、酒店、商品、知识内容和咨询服务整合在统一入口中，形成完整业务链路。
4. 集成智能问答能力，在农旅场景中提供辅助咨询与信息引导，增强交互体验。
5. 兼顾信息展示、交易处理与消息互动，有利于提升农旅服务场景的整体服务效率。
...
![活动详情页截图](./页面截图/活动详情页.png)

### 23.3 酒店详情页截图

![酒店详情页截图](./页面截图/酒店详情页.png)
...
![找搭子页面截图](./页面截图/找搭子.png)

### 23.6 个人主页截图

![个人主页截图](./页面截图/个人主页.jpg)
